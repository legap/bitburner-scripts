...
export const TARGETS = {
  ...
  EARLY: ["n00dles", "foodnstuff", "sigma-cosmetics", "joesguns", "hong-fang-tea", "harakiri-sushi"],

  // Mid game targets (moderate security, good money)
  MID: ["joesguns", "hong-fang-tea", "harakiri-sushi", "iron-gym", "zer0", "max-hardware", "CSEC"],
...
export const RECOMMENDED_SETTINGS = {
  ...
  THREAD_DISTRIBUTION: {
    ...
    WEAKEN_PERCENT: 0.3, // 30% weaken threads
  },
