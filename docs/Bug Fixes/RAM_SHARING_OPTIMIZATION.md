...
The original `share-ram.js` script used **4.05GB** of RAM due to logging overhead (hostname tracking, runtime
calculation, cycle counting, status prints). Since server RAM comes in multiples of 4GB (8GB, 16GB, 32GB, 64GB), this
0.05GB overhead caused significant RAM waste across the entire network.
