...
- **Deployment scripts** (auto-deploy-all.js, purchase-server-8gb.js, deploy-hack-joesguns.js, home-batcher.js,
...
Your Bitburner script collection is now fully organized and ready to use. Start with the basic commands and gradually
work your way up to more advanced operations as you gain experience and resources.
